    ...
    div(class: "flex items-center justify-center") do
      if Current.user
        button_to(
          "/sign_out",
          method: :delete,
          class: "inline-flex items-center justify-center px-6 py-3 mr-6 text-lg border border-transparent font-medium rounded-md text-white bg-gray-900 hover:bg-gray-700"
        ) do
          github_icon
          plain "Logout"
        end
